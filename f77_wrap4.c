...
void Cffiter(int n_cols, int* units, int* colnum, char* colname[], int* datatype,
             int* iotype, long offset, long n_per_loop, void* Fwork_fn, void* userData,
             int* status);
...
void Cffiter(int n_cols, int* units, int* colnum, char* colname[], int* datatype,
    ...
    ffiter(n_cols, cols, offset, n_per_loop, Cwork_fn, (void*)&FuserData, status);
    free(cols);
}
#define ftiter_STRV_A4 NUM_ELEM_ARG(1)
FCALLSCSUB11(Cffiter, FTITER, ftiter, INT, INTV, INTV, STRINGV, INTV, INTV, LONG, LONG,
             PVOID, PVOID, PINT)
...
int Cwork_fn(long total_n, long offset, long first_n, long n_values, int n_cols,
             iteratorCol* cols, void* FuserData) {
    ...
    if (ptrs == NULL) return (MEMORY_ALLOCATION);
    ...
    for (i = 0; i < n_cols; i++) {
        for (j = 0; j < NMAXFILES; j++)
            if (cols[i].fptr == gFitsFiles[j]) units[i] = j;
        ...
        if (datatype[i] == TLOGICAL) {
            ...
            for (j = 0; j <= n_values; j++)
                for (k = strlen(sptr[j]); k < slen[nstr]; k++) sptr[j][k] = ' ';
#ifdef vmsFortran
    ...
    if (!status) {
        ...
        f->Fwork_fn(&a1, &a2, &a3, &a4, &n_cols, units, colnum, datatype, iotype,
                    repeat, &status, f->userData, ptrs[0], ptrs[1], ptrs[2], ptrs[3],
                    ptrs[4], ptrs[5], ptrs[6], ptrs[7], ptrs[8], ptrs[9], ptrs[10],
                    ptrs[11], ptrs[12], ptrs[13], ptrs[14], ptrs[15], ptrs[16],
                    ptrs[17], ptrs[18], ptrs[19], ptrs[20], ptrs[21], ptrs[22],
                    ptrs[23], ptrs[24]);
    }
...
/*--------------------- WCS Utilities ----------------------------*/
FCALLSCSUB10(ffgics, FTGICS, ftgics, FITSUNIT, PDOUBLE, PDOUBLE, PDOUBLE, PDOUBLE,
             PDOUBLE, PDOUBLE, PDOUBLE, PSTRING, PINT)
FCALLSCSUB11(ffgicsa, FTGICSA, ftgicsa, FITSUNIT, BYTE, PDOUBLE, PDOUBLE, PDOUBLE,
             PDOUBLE, PDOUBLE, PDOUBLE, PDOUBLE, PSTRING, PINT)
FCALLSCSUB12(ffgtcs, FTGTCS, ftgtcs, FITSUNIT, INT, INT, PDOUBLE, PDOUBLE, PDOUBLE,
             PDOUBLE, PDOUBLE, PDOUBLE, PDOUBLE, PSTRING, PINT)
FCALLSCSUB13(ffwldp, FTWLDP, ftwldp, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE,
             DOUBLE, DOUBLE, DOUBLE, STRING, PDOUBLE, PDOUBLE, PINT)
FCALLSCSUB13(ffxypx, FTXYPX, ftxypx, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE, DOUBLE,
             DOUBLE, DOUBLE, DOUBLE, STRING, PDOUBLE, PDOUBLE, PINT)
...
CFARGT14(NCF,DCF,ABSOFT_cf2(VOID),LONG,PSTRING,PINT,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0))
{
    ...
    ffi2c(TCF(fti2c, LONG, 1, 0) TCF(fti2c, PSTRING, 2, 1) TCF(fti2c, PINT, 3, 1));
...
CFARGT14(NCF,DCF,ABSOFT_cf2(VOID),LOGICAL,PSTRING,PINT,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0))
{
    ...
    ffl2c(TCF(ftl2c, LOGICAL, 1, 0) TCF(ftl2c, PSTRING, 2, 1) TCF(ftl2c, PINT, 3, 1));
...
CFARGT14(NCF,DCF,ABSOFT_cf2(VOID),FLOAT,INT,PSTRING,PINT,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0))
{
    ...
    ffr2f(TCF(ftr2f, FLOAT, 1, 0) TCF(ftr2f, INT, 2, 1) TCF(ftr2f, PSTRING, 3, 1)
                  TCF(ftr2f, PINT, 4, 1));
...
CFARGT14(NCF,DCF,ABSOFT_cf2(VOID),FLOAT,INT,PSTRING,PINT,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0))
{
    ...
    ffr2e(TCF(ftr2e, FLOAT, 1, 0) TCF(ftr2e, INT, 2, 1) TCF(ftr2e, PSTRING, 3, 1)
                  TCF(ftr2e, PINT, 4, 1));
...
CFARGT14(NCF,DCF,ABSOFT_cf2(VOID),DOUBLE,INT,PSTRING,PINT,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0))
{
    ...
    ffd2f(TCF(ftd2f, DOUBLE, 1, 0) TCF(ftd2f, INT, 2, 1) TCF(ftd2f, PSTRING, 3, 1)
                  TCF(ftd2f, PINT, 4, 1));
...
CFARGT14(NCF,DCF,ABSOFT_cf2(VOID),DOUBLE,INT,PSTRING,PINT,PINT,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0,CF_0))
{
    ...
    ffd2e(TCF(ftd2e, DOUBLE, 1, 0) TCF(ftd2e, INT, 2, 1) TCF(ftd2e, PSTRING, 3, 1)
                  TCF(ftd2e, PINT, 5, 1));
...
FCALLSCSUB8(fftexp, FTTEXP, fttexp, FITSUNIT, STRING, INT, PINT, PLONG, PINT, LONGV,
            PINT)
...
FCALLSCSUB9(fffrwc, FTFRWC, ftfrwc, FITSUNIT, STRING, STRING, STRING, STRING, LONG,
            DOUBLEV, LOGICALV, PINT)
...
FCALLSCSUB9(ffcrow, FTCROW, ftcrow, FITSUNIT, INT, STRING, LONG, LONG, PVOID, PVOID,
            PLOGICAL, PINT)
...
FCALLSCSUB9(ffcalc_rng, FTCALC_RNG, ftcalc_rng, FITSUNIT, STRING, FITSUNIT, STRING,
            STRING, INT, LONGV, LONGV, PINT)
