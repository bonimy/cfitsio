...
*/
{
    ...
    */
    ...
    if (fits_is_compressed_image(fptr, status)) {
        ...
        fits_write_compressed_pixels(fptr, TUINT, firstelem, nelem, 0, array,
                                     &nullvalue, status);
        return (*status);
    }
...
*/
{
    ...
    */
    ...
    if (fits_is_compressed_image(fptr, status)) {
        ...
        fits_write_compressed_pixels(fptr, TUINT, firstelem, nelem, 1, array,
                                     &nullvalue, status);
        return (*status);
    }
            ...
            */
            ...
            switch (tcode) {
                case (TLONG):
                    ...
                    ffuintfi4(&array[next], ntodo, scale, zero, (INT32BIT*)buffer,
                              status);
                ...
                case (TLONGLONG):
                    ...
                    ffuintfi8(&array[next], ntodo, scale, zero, (LONGLONG*)buffer,
                              status);
                ...
                case (TBYTE):
                    ...
                    ffuintfi1(&array[next], ntodo, scale, zero, (unsigned char*)buffer,
                              status);
                ...
                case (TSHORT):
                    ...
                    ffuintfi2(&array[next], ntodo, scale, zero, (short*)buffer, status);
                    ffpi2b(fptr, ntodo, incre, (short*)buffer, status);
                    break;

                case (TFLOAT):

                    ffuintfr4(&array[next], ntodo, scale, zero, (float*)buffer, status);
                    ffpr4b(fptr, ntodo, incre, (float*)buffer, status);
                    break;

                case (TDOUBLE):
                    ffuintfr8(&array[next], ntodo, scale, zero, (double*)buffer,
                              status);
                ...
                case (TSTRING): /* numerical column in an ASCII table */
                    ...
                    {
                        ffuintfstr(&array[next], ntodo, scale, zero, cform, twidth,
                                   (char*)buffer, status);
...
*/
{
    ...
    if (scale == 1. && zero == 2147483648.) {
        ...
        for (ii = 0; ii < ntodo; ii++) output[ii] = (*(int*)&input[ii]) ^ 0x80000000;
