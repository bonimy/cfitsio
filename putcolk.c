...
*/
{
    ...
    */
    ...
    if (fits_is_compressed_image(fptr, status)) {
        ...
        fits_write_compressed_pixels(fptr, TINT, firstelem, nelem, 0, array, &nullvalue,
                                     status);
        return (*status);
    }
...
*/
{
    ...
    */
    ...
    if (fits_is_compressed_image(fptr, status)) {
        ...
        fits_write_compressed_pixels(fptr, TINT, firstelem, nelem, 1, array, &nullvalue,
                                     status);
        return (*status);
    }
...
*/
{
    ...
    */
    ...
    if (fits_is_compressed_image(fptr, status)) {
        ...
        fits_write_compressed_img(fptr, TINT, fpixel, lpixel, 0, array, NULL, status);
    ...
    if (sizeof(int) == sizeof(short))
        ...
        */
            ...
            switch (tcode) {
                case (TLONG):
                    if (writeraw) {
                        ...
                        ffintfi4(&array[next], ntodo, scale, zero, (INT32BIT*)buffer,
                                 status);
                ...
                case (TLONGLONG):
                    ...
                    ffintfi8(&array[next], ntodo, scale, zero, (LONGLONG*)buffer,
                             status);
                ...
                case (TBYTE):
                    ...
                    ffintfi1(&array[next], ntodo, scale, zero, (unsigned char*)buffer,
                             status);
                ...
                case (TSHORT):
                    ...
                    ffintfi2(&array[next], ntodo, scale, zero, (short*)buffer, status);
                    ffpi2b(fptr, ntodo, incre, (short*)buffer, status);
                    break;

                case (TFLOAT):

                    ffintfr4(&array[next], ntodo, scale, zero, (float*)buffer, status);
                    ffpr4b(fptr, ntodo, incre, (float*)buffer, status);
                    break;

                case (TDOUBLE):
                    ffintfr8(&array[next], ntodo, scale, zero, (double*)buffer, status);
                ...
                case (TSTRING): /* numerical column in an ASCII table */
                    ...
                    {
                        ffintfstr(&array[next], ntodo, scale, zero, cform, twidth,
                                  (char*)buffer, status);
        ...
        if (*status == OVERFLOW_ERR) {
            ffpmsg("Numerical overflow during type conversion while writing FITS "
                   "data.");
            *status = NUM_OVERFLOW;
        }
